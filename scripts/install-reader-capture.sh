...
echo
echo "使用例:"
echo "  reader_capture               # 会話形式（Kindle/Legend/BlueChartを選んで入力）"
echo "  reader_capture kindle 188 220"
echo "  reader_capture legend 14 20"
echo "  reader_capture bluechart 515 594   # sviewer（青チャート等）・紙面ページ番号で指定"
echo
echo "初回はシステム設定でWezTerm(実行するターミナル)に次の権限を与えてください:"
echo "  - プライバシーとセキュリティ → アクセシビリティ"
echo "  - プライバシーとセキュリティ → 画面収録"
echo "  - (Legend/BlueChart) オートメーションでGoogle Chromeの操作を許可"
echo "  - (Legend/BlueChart) Chrome: 表示 > デベロッパ > Apple EventからのJavaScriptを許可"
